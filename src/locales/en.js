...
export default {
    ...
    roleStudent:"Student",
    roleTeacher:"Teacher",
    authFineprintBefore:"By joining, you agree to the",
    authQuestRules:"Quest Rules",
    demoPassageLabel:"Demo passage",
    demoBeginQuiz:"Begin Quiz →",
    demoQuestionOf:"Question {n} of {total}",
    demoCorrectShort:"✓ Correct.",
    demoWrongShort:"✕ Not quite.",
    demoNext:"Next →",
    demoSeeResult:"See result →",
    demoFinishedTitle:"🎉 You finished the demo",
    demoScorePerfect:"PERFECT SCORE",
    demoScoreNice:"NICE WORK",
    demoScoreGood:"GOOD TRY",
    demoTryAgain:"🔁 Try again",
    sampleCorrectMsg:"✓ Correct! Ready to read more like this?",
    sampleTryAgainMsg:"Not quite — try another option.",
    readingExitLbl:"Exit",
    readingHintLookup:"Tap any word to look it up",
    readingHintListen:"Tap a sentence to listen",
    readingHintHighlight:"Highlight mode: tap to mark words",
    readingHintPractise:"Tap a sentence to practise:",
    readingSave:"🔖 Save",
    readingSaved:"✓ Saved",
    readingPronounce:"🎤 Pronounce",
    readingPronExit:"🎤 Exit",
    quizExitConfirm:"Exit quiz? Progress will be lost.",
    resultLevelUnlocked:"LEVEL {n} UNLOCKED",
    resultXpEarned:"XP earned",
    resultAccuracy:"Accuracy",
    resultTime:"Time",
    resultRank:"Rank",
    reviewTypeAnswer:"Type your answer…",
    reviewCorrectFull:"✓ Correct!",
    reviewIncorrectFull:"✗ Incorrect",
    reviewCheckAnswer:"Check Answer",
    reviewNextCorrect:"Next →",
    reviewNextIncorrect:"Got it — Next →",
    reviewNextTomorrow:"Next review: tomorrow",
    reviewNextInDays:"Next review in {d}d if correct",
    tch_wiz1Title:"Create your first class",
    tch_wiz1Body:"Give it a name your students will recognise — e.g. \"B1 Morning Group\"",
    tch_wiz1Placeholder:"Class name…",
    tch_wiz1Cta:"Create Class →",
    tch_wiz1Skip:"Skip setup for now",
    tch_wiz2Title:"Share this code with students",
    tch_wiz2Body:"Students enter this code on their home screen to join your class instantly.",
    tch_wiz2Cta:"Next: Create an Assignment →",
    tch_wiz2Skip:"Skip for now — I'll do this later",
    tch_wiz3Title:"Create your first assignment",
    tch_wiz3Body:"Pick a story from the library or let AI generate one on any topic.",
    tch_wiz3Finish:"✓ Finish Setup →",
    tch_wiz3Skip:"Skip — I'll add assignments later",
    tch_passagePlaceholderWiz:"Paste your passage here… (150–3000 characters)",
    tch_passagePlaceholderDash:"Paste your passage here… (30–3000 characters). An AI quiz will be generated from your text.",
    tch_dueDateOptional:"Due date (optional)",
    ...
    stu_friends_search_ph:"Search by username (min 2 chars)…",
    stu_friends_search_noResults:"No users found for \"{q}\"",
    stu_friends_suggested:"SUGGESTED LEARNERS",
    stu_friends_suggested_hint:"Top learners you don't follow yet. Tap to view or add.",
    stu_friends_empty_title:"No friends yet",
    stu_friends_empty_body:"Find learners to compete with on the weekly board and get personalised nudges on your home screen.",
    stu_friends_empty_cta:"Find learners",
    ...
    slider_exit:"Exit",
    slider_err_title:"Couldn't load cards",
    slider_err_retry:"Retry",
    slider_cap_title:"Daily slider cap reached",
    slider_cap_body:"You've used today's slider quota. Resets at UTC midnight — try the library or a custom passage in the meantime.",
    slider_loading_first:"Picking your first card…",
    slider_back_home:"Back home",
    slider_next:"Next Card →",
    slider_finish:"Finish session →",
    slider_explain_right:"Right",
    slider_explain_wrong:"Heads-up",
    slider_summary_title:"Session done",
    slider_summary_body:"Nice work — you're done for the day. Stats below.",
    slider_summary_cards:"Cards",
    slider_summary_correct:"Correct",
    slider_summary_accuracy:"Accuracy",
    slider_summary_new:"Another session",
    slider_end_early:"End session",
    push_title:"Push reminders",
    push_desc_on:"On — we'll send a daily nudge",
    push_desc_off:"Off — turn on to enable scheduled prompts",
    push_exam_label:"EXAM DATE (optional)",
    push_exam_hint:"As your exam gets closer, reminders ramp up automatically.",
    push_save:"Save",
    push_saving:"Saving…",
    push_test_title:"Send a test",
    push_test_desc:"Make sure your device gets the notification",
    push_msg_enabled:"Push reminders enabled",
    push_msg_disabled:"Push reminders turned off",
    push_msg_saved:"Saved",
