...
export default {
    ...
    roleStudent:"Schüler",
    roleTeacher:"Lehrer",
    authFineprintBefore:"Mit der Registrierung akzeptierst du die",
    authQuestRules:"Quest-Regeln",
    demoPassageLabel:"Demo-Text",
    demoBeginQuiz:"Quiz starten →",
    demoQuestionOf:"Frage {n} von {total}",
    demoCorrectShort:"✓ Richtig.",
    demoWrongShort:"✕ Nicht ganz.",
    demoNext:"Weiter →",
    demoSeeResult:"Ergebnis ansehen →",
    demoFinishedTitle:"🎉 Demo abgeschlossen",
    demoScorePerfect:"PERFEKT",
    demoScoreNice:"GUT GEMACHT",
    demoScoreGood:"GUTER VERSUCH",
    demoTryAgain:"🔁 Nochmal versuchen",
    sampleCorrectMsg:"✓ Richtig! Bereit, mehr zu lesen?",
    sampleTryAgainMsg:"Nicht ganz — versuch eine andere Option.",
    readingExitLbl:"Schließen",
    readingHintLookup:"Tippe ein Wort an für die Übersetzung",
    readingHintListen:"Tippe einen Satz zum Anhören",
    readingHintHighlight:"Markierungsmodus: Wörter antippen",
    readingHintPractise:"Tippe einen Satz zum Üben:",
    readingSave:"🔖 Speichern",
    readingSaved:"✓ Gespeichert",
    readingPronounce:"🎤 Aussprache",
    readingPronExit:"🎤 Schließen",
    quizExitConfirm:"Quiz beenden? Fortschritt geht verloren.",
    resultLevelUnlocked:"LEVEL {n} FREIGESCHALTET",
    resultXpEarned:"XP verdient",
    resultAccuracy:"Genauigkeit",
    resultTime:"Zeit",
    resultRank:"Rang",
    reviewTypeAnswer:"Antwort eingeben…",
    reviewCorrectFull:"✓ Richtig!",
    reviewIncorrectFull:"✗ Falsch",
    reviewCheckAnswer:"Antwort prüfen",
    reviewNextCorrect:"Weiter →",
    reviewNextIncorrect:"Verstanden — Weiter →",
    reviewNextTomorrow:"Nächste Wiederholung: morgen",
    reviewNextInDays:"Bei richtiger Antwort nächste Wiederholung in {d} Tagen",
    tch_wiz1Title:"Erstelle deine erste Klasse",
    tch_wiz1Body:"Gib einen Namen, den deine Schüler erkennen — z. B. \"B1 Morgengruppe\"",
    tch_wiz1Placeholder:"Klassenname…",
    tch_wiz1Cta:"Klasse erstellen →",
    tch_wiz1Skip:"Vorerst überspringen",
    tch_wiz2Title:"Teile diesen Code mit den Schülern",
    tch_wiz2Body:"Schüler geben diesen Code auf ihrem Startbildschirm ein, um deiner Klasse beizutreten.",
    tch_wiz2Cta:"Weiter: Aufgabe erstellen →",
    tch_wiz2Skip:"Später erledigen",
    tch_wiz3Title:"Erstelle deine erste Aufgabe",
    tch_wiz3Body:"Wähle eine Geschichte aus der Bibliothek oder lass die KI eine zu deinem Thema erstellen.",
    tch_wiz3Finish:"✓ Einrichtung abschließen →",
    tch_wiz3Skip:"Überspringen — Aufgaben später hinzufügen",
    tch_passagePlaceholderWiz:"Text hier einfügen… (150–3000 Zeichen)",
    tch_passagePlaceholderDash:"Text hier einfügen… (30–3000 Zeichen). KI erstellt ein Quiz aus deinem Text.",
    tch_dueDateOptional:"Fälligkeitsdatum (optional)",
    ...
    stu_friends_search_ph:"Nach Benutzernamen suchen (min. 2 Zeichen)…",
    stu_friends_search_noResults:"Keine Benutzer für \"{q}\" gefunden",
    stu_friends_suggested:"EMPFOHLENE LERNENDE",
    stu_friends_suggested_hint:"Aktive Lernende, denen du noch nicht folgst. Tippen zum Ansehen oder Hinzufügen.",
    stu_friends_empty_title:"Noch keine Freunde",
    stu_friends_empty_body:"Finde Lernende, um auf der Wochentabelle anzutreten und persönliche Hinweise auf dem Home-Screen zu erhalten.",
    stu_friends_empty_cta:"Lernende finden",
